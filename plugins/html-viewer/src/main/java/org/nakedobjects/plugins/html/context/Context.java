...
public class Context {
    ...
    private ObjectMapping objectMapping(final NakedObject adapter) {
    ...
    public void processChanges() {
        List<NakedObject> disposedObjects = NakedObjectsContext.getUpdateNotifier().getDisposedObjects();
        for (NakedObject nakedObject : disposedObjects) {
            ObjectMapping mapping = objectMapping(nakedObject);
