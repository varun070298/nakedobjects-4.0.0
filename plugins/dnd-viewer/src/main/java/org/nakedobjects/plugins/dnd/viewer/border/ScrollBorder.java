...
import org.nakedobjects.plugins.dnd.viewer.view.simple.NullView;
...
public class ScrollBorder extends AbstractViewDecorator {
    ...
    private void drawHorizontalScrollBar(final Canvas canvas, final int contentWidth, final int contentHeight, final Color color) {
        ...
        if (bottom > 0 && (horizontalScrollPosition > left || horizontalVisibleAmount < contentWidth)) {
            ...
            final int x = left + horizontalScrollPosition;
    ...
    private Offset offset() {
        ...
        final int x = width == 0 ? 0 : horizontalScrollBar.getPosition() * wrappedView.getRequiredSize(new Size()).getWidth()
                / width;
        final int height = contents.getHeight();
        final int y = height == 0 ? 0 : verticalScrollBar.getPosition() * wrappedView.getRequiredSize(new Size()).getHeight()
                / height;
    ...
    public void setSize(final Size size) {
        ...
        final Size contentSize = wrappedView.getRequiredSize(new Size());
