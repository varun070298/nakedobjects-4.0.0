...
import org.nakedobjects.plugins.dnd.viewer.basic.PopupMenuContainer;
...
public class XViewer implements Viewer {
    ...
    public XViewer() {
        ...
        showExplorationMenuByDefault = NakedObjectsContext.getConfiguration().getBoolean(
                Properties.PROPERTY_BASE + "exploration.show", true);
